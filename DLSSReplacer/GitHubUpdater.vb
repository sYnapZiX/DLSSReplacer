Public Class GitHubUpdater
    Structure Properties
        ...
        Shared ReadOnly Property RepositoryName As String = My.Application.Info.AssemblyName
    ...
    Structure UserInterface
        Public Shared Sub CheckStage1() '                                                 ### YOUR UI CODE THAT HAPPENS BEFORE CHECKING FOR UPDATES ##############################################################################################################################################################################################################
            ...
            If MainWindow.Language = "de" Then
                MainWindow.ScanButton.Text = "Suche nach Updates..."
                MainWindow.ReplaceButton.Text = "Suche nach Updates..."
            Else
                MainWindow.ScanButton.Text = "Checking for updates..."
                MainWindow.ReplaceButton.Text = "Checking for updates..."
            End If
        End Sub
        Public Shared Sub CheckTrue() '                                                   ### YOUR UI CODE THAT HAPPENS IF AN UPDATE IS AVAILABLE ################################################################################################################################################################################################################
            If MainWindow.Language = "de" Then
                MainWindow.ScanButton.Text = "Laufwerk/Ordner scannen..."
                MainWindow.ReplaceButton.Text = "Ersetzen"
            Else
                MainWindow.ScanButton.Text = "Scan Drive/Folder..."
                MainWindow.ReplaceButton.Text = "Replace"
            End If
        ...
        Public Shared Sub DownloadProgress(Progress As Integer, AssetPart As Integer) '   ### YOUR UI CODE THAT HAPPENS DURING DOWNLOAD ##########################################################################################################################################################################################################################
            If MainWindow.Language = "de" Then
                MainWindow.ScanButton.Text = "Lade Update herunter: " & Progress.ToString & "%"
                MainWindow.ReplaceButton.Text = "Lade Update herunter: " & Progress.ToString & "%"
            Else
                MainWindow.ScanButton.Text = "Downloading update: " & Progress.ToString & "%"
                MainWindow.ReplaceButton.Text = "Downloading update: " & Progress.ToString & "%"
            End If
        End Sub
